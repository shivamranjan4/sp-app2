...
import com.example.spapp2.dto.ChangePasswordDTO;
import com.example.spapp2.dto.ForgotPasswordDTO;
import com.example.spapp2.dto.LoginDTO;
import com.example.spapp2.dto.PasswordResetSuccessDTO;
import com.example.spapp2.dto.ResetPasswordDTO;
import com.example.spapp2.entity.AppUser;
import com.example.spapp2.service.AppUserService;
import com.example.spapp2.service.MailService;
...
public class AdminController {
	...
	public ResponseEntity<PasswordResetSuccessDTO> resetPassword(@RequestBody ResetPasswordDTO resetPasswordDTO) {
		String message = appUserService.resetPassword(resetPasswordDTO.getEmail(), resetPasswordDTO.getActivationCode(),
